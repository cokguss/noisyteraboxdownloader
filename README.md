...
4. (Untuk statistik pengunjung persisten) tambahkan env var `DATABASE_URL` dengan connection string Neon (pooled) dari [console.neon.tech](https://console.neon.tech). Tanpa env ini statistik tetap jalan tapi hanya in-memory (reset tiap deploy).
